...
export const ProjectList = [
  ...
  {
    id: "nba-analytics-tool",
    name: "NBA Analytics Tool",
    image: NBA,
    skills: "React, Python, Flask, Scikit-Learn, HTML, CSS",
    tags: ["React", "Python", "Flask", "Scikit-Learn", "HTML", "CSS"],
    githubLink: "https://github.com/loknara/Prop-er",
    blurb1:
      "A project my friends and I are currenlty working on, aimed to help sports better better view thier sports bets as well as make more educated bets based on our model. I Architected a RESTful API with Flask to allow users to search for players currenlty playing in a game to veiw thier live stats. Our model has attained a game predicting accuracy of 67% and player scoring accuracy of 65% through a Regression model based on data and optimized parameters.s ",
  },

  {
    id: "insurance-chatbot",
